...
public class StringFirstAggregatorTest
{
  ...
  public void testAllFields() throws JsonProcessingException, JSONException
  {
    ...
    StringFirstAggregator aggregator = StringFirstAggregator.builder()
                                                            .name("string_name")
  ...
  public void testEqualsPositive()
  {
    ...
    StringFirstAggregator aggregator1 = StringFirstAggregator.builder()
                                                            .fieldName("some_dimension")
                                                            .name("string_name")
                                                            .build();

    StringFirstAggregator aggregator2 = StringFirstAggregator.builder()
                                                            .fieldName("some_dimension")
                                                            .name("string_name")
                                                            .build();
  ...
  public void testRename()
  {
    StringFirstAggregator aggregator1 = StringFirstAggregator.builder()
                                                             ...
                                                             .name("name")
                                                             .build();
    StringFirstAggregator aggregator2 = (StringFirstAggregator) aggregator1.withName("newName");
    Assert.assertNotEquals(aggregator1, aggregator2);
