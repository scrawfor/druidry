...
public class IntervalFilterTest {
    ...
    public void testFields() throws JsonProcessingException, JSONException {
        ...
        ZonedDateTime startTimeInterval1 = ZonedDateTime.of(LocalDate.of(2013, 8, 31), LocalTime.of(0,0,0), ZoneId.of("UTC"));
        ZonedDateTime endTimeInterval1 = ZonedDateTime.of(LocalDate.of(2013, 9, 3), LocalTime.of(0,0,0), ZoneId.of("UTC"));
        ZonedDateTime startTimeInterval2 = ZonedDateTime.of(LocalDate.of(2018, 8, 31), LocalTime.of(0,0,0), ZoneId.of("UTC"));
        ZonedDateTime endTimeInterval2 = ZonedDateTime.of(LocalDate.of(2018, 9, 3), LocalTime.of(0,0,0), ZoneId.of("UTC"));
